...
namespace HeuristicLab.Selection
{
    ...
    /// </summary>
    [Item("EliteSelectorWithInsertedSolution", "A selection operator which considers a single double quality value and selects the best.")]
    [StorableClass]
    public sealed class EliteSelectorWithInsertedSolution : SingleObjectiveSelector, ISingleObjectiveSelector
    {
        public EliteSelectorWithInsertedSolution() : base() { }
        [StorableConstructor]
        private EliteSelectorWithInsertedSolution(bool deserializing) : base(deserializing) { }
        private EliteSelectorWithInsertedSolution(EliteSelectorWithInsertedSolution original, Cloner cloner)
          : base(original, cloner)
        {
        }
        public override IDeepCloneable Clone(Cloner cloner)
        {
            return new EliteSelectorWithInsertedSolution(this, cloner);
        }
        ...
        protected override IScope[] Select(List<IScope> scopes)
        {
            ...
            IScope[] selected = new IScope[count+1];
