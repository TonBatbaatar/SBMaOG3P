...
namespace HeuristicLab.Algorithms.CFG.MultiObjective
{
  ...
  /// </summary>
  [Item("Custom Genetic Algorithm (GA)", "A genetic algorithm.")]
  ...
  public sealed class GeneticAlgorithm : HeuristicOptimizationEngineAlgorithm, IStorableContent {
    ...
    public GeneticAlgorithm()
      ...
      ISelector tournamentSelector = SelectorParameter.ValidValues.FirstOrDefault(x => x.GetType().Name.Equals("TournamentSelector"));
            ((TournamentSelector)tournamentSelector).GroupSizeParameter.Value = new IntValue(7);
    ...
    private void UpdateMutators() {
      ...
      IManipulator treeshaker = MutatorParameter.ValidValues.FirstOrDefault(x => x.GetType().Name.Equals("MultiSymbolicExpressionTreeManipulator"));
      if (treeshaker != null) defaultMutator = treeshaker;
