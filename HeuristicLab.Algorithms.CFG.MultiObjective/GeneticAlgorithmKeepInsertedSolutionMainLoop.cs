...
namespace HeuristicLab.Algorithms.GeneticAlgorithm
{
    ...
    [StorableClass]
    public sealed class GeneticAlgorithmKeepInsertedSolutionMainLoop : AlgorithmOperator
    {
        ...
        [StorableConstructor]
        private GeneticAlgorithmKeepInsertedSolutionMainLoop(bool deserializing) : base(deserializing) { }
        private GeneticAlgorithmKeepInsertedSolutionMainLoop(GeneticAlgorithmKeepInsertedSolutionMainLoop original, Cloner cloner)
          : base(original, cloner)
        {
        }
        public override IDeepCloneable Clone(Cloner cloner)
        {
            return new GeneticAlgorithmKeepInsertedSolutionMainLoop(this, cloner);
        }
        public GeneticAlgorithmKeepInsertedSolutionMainLoop()
          : base()
        {
            Initialize();
        }
        ...
        private void Initialize()
        {
            ...
            EliteSelectorWithInsertedSolution bestSelector = new EliteSelectorWithInsertedSolution();
            ...
            comparator2.Comparison = new Comparison(ComparisonType.LessOrEqual);
            comparator2.LeftSideParameter.ActualName = "Best training solution quality";
            comparator2.ResultParameter.ActualName = "Terminate";
            comparator2.RightSideParameter.Value = new DoubleValue(0.01);
            ...
            comparator.Successor = conditionalBranch2;
            conditionalBranch2.FalseBranch = comparator2;
            conditionalBranch2.TrueBranch = analyzer2;
            conditionalBranch2.Successor = null;
            comparator2.Successor = analyzer2;
